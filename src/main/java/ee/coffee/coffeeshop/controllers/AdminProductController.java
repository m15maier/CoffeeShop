...
public class AdminProductController extends AbstractController {
    ...
    public String edit(Model model, @PathVariable Long id) {
        Product product = EntityUtil.isNew(id) ? new Product() : productService.getProductById(id);
    ...
    public String save(Model model,
        ...
        try {
            productService.saveProduct(getUser(userDetails), product, previewImageFile);
    ...
    public String delete(@PathVariable Long id) {
        return doWithRedirect(LIST, () -> productService.deleteProduct(id));
    }
}
